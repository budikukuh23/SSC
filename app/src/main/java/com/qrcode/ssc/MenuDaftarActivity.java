...
public class MenuDaftarActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView iv6 = findViewById(R.id.gamb_vacuum_generator);
        ...
        String ui6 = "https://firebasestorage.googleapis.com/v0/b/my-thesis-c5a39.appspot.com/o/image%2FVacuum%20generator%2Fvacuum_generator1.jpg?alt=media&token=0c1081a3-6b93-43c1-825b-98c40f50f8f5";
        ...
        String ui13 = "https://firebasestorage.googleapis.com/v0/b/my-thesis-c5a39.appspot.com/o/ASRS%2FRelay%20Module.png?alt=media&token=0dc73b87-5396-42bf-8870-b054b08d2bd9";
        String ui14 = "https://firebasestorage.googleapis.com/v0/b/my-thesis-c5a39.appspot.com/o/ASRS%2FStandard%20parallel%20gripper%20HGP.png?alt=media&token=88bb3897-1fbc-4d07-b49b-b73d0aeda0a2";
        String ui15 = "https://firebasestorage.googleapis.com/v0/b/my-thesis-c5a39.appspot.com/o/ASRS%2FPneumatic%20Liniear%20Drive2.png?alt=media&token=1daff691-34db-4218-9772-a29645717c41";
        ...
        String ui17 = "https://firebasestorage.googleapis.com/v0/b/my-thesis-c5a39.appspot.com/o/ASRS%2FPlanar%20Surface%20Gantry%20Module.jpg?alt=media&token=ff0b571a-04b3-4193-8ad2-e5f2f98ab702";
        String ui18 = "https://firebasestorage.googleapis.com/v0/b/my-thesis-c5a39.appspot.com/o/ASRS%2FElectrical%20toothed%20belt%20axis.png?alt=media&token=18f990db-2533-43b8-a33b-61fd0d86c602";
        ...
        String ui20 = "https://firebasestorage.googleapis.com/v0/b/my-thesis-c5a39.appspot.com/o/ASRS%2FStorage%20Places%20Module.png?alt=media&token=874ef23f-67bb-48f3-9db7-4eee1eda995c";
        ...
        String ui22 = "https://firebasestorage.googleapis.com/v0/b/my-thesis-c5a39.appspot.com/o/image%2FPart%2FControl%20console.jpg?alt=media&token=fe31c41f-2100-49e7-b29b-d860298d7622";
        ...
        cv6 = findViewById(R.id.vacuum_generator);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.vacuum_generator: i = new Intent(this,VacuumGenerator.class); startActivity(i); break;
            ...
            case R.id.relay_module: i = new Intent(this,RelayModule.class); startActivity(i); break;
            case R.id.pneumatic_gripper: i = new Intent(this,PneumaticGripper.class); startActivity(i); break;
            case R.id.pneumatic_liniear_drive: i = new Intent(this,PneumaticLiniearDriver.class); startActivity(i); break;
            case R.id.proximity_sensor2: i = new Intent(this,ProximitySensor2.class); startActivity(i); break;
            case R.id.planar_surface_gantry_module: i = new Intent(this,PlanarSurfaceGantryModule.class); startActivity(i); break;
            case R.id.electrical_toothed_belt_axis: i = new Intent(this,ElectricalToothedBeltAxis.class); startActivity(i); break;
            case R.id.cp_valve_terminal: i = new Intent(this,CpValveTerminal.class); startActivity(i); break;
            case R.id.storage_places_module: i = new Intent(this,StoragePlacesModule.class); startActivity(i); break;
