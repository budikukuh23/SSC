...
public class Video1Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        judulVideo.setText("ASRS Station");
        sumberVideo.setText("Sumber: Youtube/VWCCMediaGeeks");

        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);

        Uri videoUrl = Uri.parse("https://firebasestorage.googleapis.com/v0/b/my-thesis-c5a39.appspot.com/o/ASRS%2FASRS%20Station%20Festo.mp4%20-%20Google%20Drive.mp4?alt=media&token=603fa6e2-391f-4eef-8e74-edf2765fa068");
        ...
        simpleExoPlayer = ExoPlayerFactory.newSimpleInstance(
                Video1Activity.this,trackSelector,loadControl
        );
